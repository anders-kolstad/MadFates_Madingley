...
\hypersetup{
  pdftitle={Runngin the Madingley Model with Norwegian data},
  pdfauthor={Anders L. Kolstad},
  hidelinks,
...
\title{Runngin the Madingley Model with Norwegian data}
...
\KeywordTok{install_github}\NormalTok{(}\StringTok{'MadingleyR/MadingleyR'}\NormalTok{, }\DataTypeTok{subdir=}\StringTok{'Package'}\NormalTok{, }\DataTypeTok{build_vignettes =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
